      ...
      <form onSubmit={this.handleSubmit}>
        ...
        <button type="submit">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="22.149" height="22.149" viewBox="0 0 22.149 22.149">
                ...
                <path id="Icon_map-search" data-name="Icon map-search" d="M17.647,14.7A8.759,8.759,0,1,0,14.7,17.646l5.943,5.943,2.947-2.949Zm-7.468.886a5.4,5.4,0,1,1,5.406-5.4,5.412,5.412,0,0,1-5.406,5.4Z" transform="translate(-1.44 -1.44)" fill="url(#linear-gradient)"/>
            </svg>
        </button>
      </form>
    );
